...
func RegisterDefaultKarakas() {
	RegisterKaraka(Karaka{
		...
		Tools: map[string]string{
			...
			"browser.input":        "ask",
			"browser.cdp_click":    "allow",
			"browser.cdp_type":     "allow",
			"browser.cdp_eval":     "allow",
			"browser.cdp_text":     "allow",
			"browser.cdp_nav":      "allow",
			"research.search":      "allow",
			"research.notes":       "allow",
			"research.fetch":       "ask",
			"research.note":        "allow",
			"llm.chat":             "allow",
			"karaka.delegate":      "allow",
		},
		MaxSteps: 10,
	})
	RegisterKaraka(Karaka{
